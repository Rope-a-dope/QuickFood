...
<head>
    ...
    <link href="/static/css/2.c02757eb.chunk.css" rel="stylesheet">
    <link href="/static/css/main.9311cd49.chunk.css" rel="stylesheet">
</head>
<body>
...
<script>!function (e) {
    ...
    i.e = function (e) {
        ...
        if (0 !== t) if (t) r.push(t[2]); else {
            ...
            a.charset = "utf-8", a.timeout = 120, i.nc && a.setAttribute("nonce", i.nc), a.src = function (e) {
                return i.p + "static/js/" + ({}[e] || e) + "." + {3: "b855a153"}[e] + ".chunk.js"
            }(e);
            var c = new Error;
            u = function (r) {
    ...
    var a = this.webpackJsonponlineorder_front = this.webpackJsonponlineorder_front || [], c = a.push.bind(a);
    a.push = r, a = a.slice();
    for (var l = 0; l < a.length; l++) r(a[l]);
    var f = c;
    t()
}([])</script>
<script src="/static/js/2.9765f51c.chunk.js"></script>
<script src="/static/js/main.b9573f64.chunk.js"></script>
</body>
</html>